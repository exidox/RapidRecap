...
def generate_mcqs(text):
    ...
    # Filter keywords based on low IDF scores
    result_keywords = []
    ...
    def check_sense_and_distractor(ans):
        s2v = Sense2Vec().from_disk('C:/Users/shubh/OneDrive/Desktop/all/internship/ShorthillsAI/summarizer/mcq extension/S2V/s2v_old')
        originalword = ans
